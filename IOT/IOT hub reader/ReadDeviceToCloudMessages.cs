...
namespace read_d2c_messages
{
    class ReadDeviceToCloudMessages
    {
        ...
        private readonly static string s_eventHubsCompatibleEndpoint = "sb://ihsuprodamres060dednamespace.servicebus.windows.net";

        // Event Hub-compatible name
        // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
        private readonly static string s_eventHubsCompatiblePath = "iothub-ehub-pboogaerts-2022640-506e45b865";
        
        // az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
        private readonly static string s_iotHubSasKey = "{put primary key for service role here}";
